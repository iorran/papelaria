...
var produto_service_1 = require("./../shared/services/produto.service");
var core_1 = require("@angular/core");
var router_1 = require("@angular/router");
var angular_1 = require("@ionic/angular");
var ProdutoDetailComponent = /** @class */ (function () {
    function ProdutoDetailComponent(_activatedRoute, _produtoService, _loadingController) {
    ...
    ProdutoDetailComponent.prototype.loadProduto = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        _a.sent();
                        this._produtoService.findOne(this.produto.id).subscribe(function (res) {
                            loading.dismiss();
                            console.log(res);
                            // this.produto = res;
                        });
...
//# sourceMappingURL=produto-detail.component.js.map