...
var ProdutosPage = /** @class */ (function () {
    function ProdutosPage(_produtoService, _router, _alertController) {
    ...
    ProdutosPage.prototype.add = function () {
        this._router.navigateByUrl('produtos/add');
    };
    ProdutosPage.prototype.edit = function (id) {
        this._router.navigate(['produtos/edit', id]);
    };
    ProdutosPage.prototype.remove = function (id) {
                    ...
                    case 0: return [4 /*yield*/, this._alertController.create({
                            ...
                            buttons: [
                                ...
                                },
                                {
                                    text: 'Sim',
                                    handler: function () {
                                        _this._produtoService.remove(id);
                                    },
                                },
                            ],
                        })];
